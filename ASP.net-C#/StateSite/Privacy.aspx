<%@ Page Title="Explore Kansas || Privacy" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="Privacy.aspx.cs" Inherits="ProjectVer1Steven.Privacy" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
.highlight{background:#FFE;}*{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;}.article p{margin-top:1em;margin-bottom:1em;}p{margin:0 0 20px 0;}p{margin:0 0 10px;}.article h2{font-size:20px;font-weight:700;margin-bottom:1em;}h2,.h2{font-size:30px;}
    .auto-style3 {
        font-family: inherit;
        font-weight: 400;
        line-height: 1.1;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Privacy Policy of Explore Kansas</h1>
<p>
    Explore Kansas operates the ExploreKansas.com website, which provides the information on the state of Kansas.</p>
<p>
    This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the website.</p>
<p>
    If you choose to use our Service, then you agree to the collection and use of information in relation with this policy. The Personal Information that we collect are used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.</p>
<p>
    The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at exploreKansas.com, unless otherwise defined in this Privacy Policy.</p>
<h2 class="auto-style3">Information Collection and Use</h2>
<p>
...
<h2 class="auto-style3">Service Providers</h2>
<p>
...
<h2 class="auto-style3">Security</h2>
<p>
    We value your trust in providing us your Personal Information, thus we are striving to use commercially acceptable means of protecting it. But remember that no method of transmission over the internet, or method of electronic storage is 100% secure and reliable, and we cannot guarantee its absolute security.</p>
<h2 class="auto-style3">Links to Other Sites</h2>
<p>
...
<h2 class="auto-style3">Changes to This Privacy Policy</h2>
<p>
...
<p>
    Source :https://privacypolicytemplate.net/#wizard</p>
</asp:Content>
